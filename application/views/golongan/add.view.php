<h4 class="mt-2">Tambah Golongan</h4>
<hr>
<form method="post" action="<?= BASE_PATH ?>/golongan/insert" enctype="multipart/form-data">

   <div class="form-group row">
      <label for="gol_kode" class="col-sm-2 col-form-label">Kode Golongan</label>   
      <div class="col-sm-4">   
       <input class="form-control" type="text" id="gol_kode" name="gol_kode">
     </div> 
   </div>
   ...
   <div class="form-group row">
      ...
      <div class="col-sm-4">   
       <input class="form-control" type="text" id="gol_nama" name="gol_nama">
     </div> 
   </div>
